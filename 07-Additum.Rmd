...
```{r fig7-1, fig.cap='Verwandtschaftsverhältnisse über vier Generationen.', out.width='50%', echo= F, fig.align= 'center'}
knitr::include_graphics('figures/fig7-1.png')
```
...
```{r fig7-2, fig.cap='Verschiedene Verwandtschaftsgrad-Berechnungen in einem fiktiven Familienstammbaum.', out.width='90%', echo= F, fig.align= 'center'}
knitr::include_graphics('figures/fig7-2.png')
```
...
```{r fig7-3, fig.cap='Abstammungsverhältnisse im Bienenstock.', out.width='50%', echo= F, fig.align= 'center'}
knitr::include_graphics('figures/fig7-3.png')
```
...
```{r fig7-4, fig.cap='Abstammungsverhältnisse der Arbeiterinnen im Bienenstock im Vergleich mit dem Vater.', out.width='70%', echo= F, fig.align= 'center'}
knitr::include_graphics('figures/fig7-4.png')
```
