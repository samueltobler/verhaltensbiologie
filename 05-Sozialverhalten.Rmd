...
```{r fig5-1, fig.cap='Infantizid wurde beim Feldhamster (links), der Echsenart _Eutropis longicaudata_ (Mitte) und der Sandgrundel (rechts) gefunden. ', out.width='80%', echo= F, fig.align= 'center'}
knitr::include_graphics('figures/fig5-1.png')
```
...
```{r fig5-2, fig.cap='Honigbiene an Lavendelblüte.', out.width='80%', echo= F, fig.align= 'center'}
knitr::include_graphics('figures/fig5-2.png')
```
...
```{r fig5-3, fig.cap='Verwandtschaftsverhältnisse der Honigbiene.', out.width='80%', echo= F, fig.align= 'center'}
knitr::include_graphics('figures/fig5-3.png')
```
...
```{r fig5-4, fig.cap='Der Bienenstock. ', out.width='80%', echo= F, fig.align= 'center'}
knitr::include_graphics('figures/fig5-4.png')
```
...
```{r fig5-5, fig.cap='Moralische Aspekte unseres alltäglichen Altruismus-Verständnisses können zu Diskussionen führen. ', out.width='1%', echo= F,  out.extra='class="custom-figure"', fig.align= 'center' }
