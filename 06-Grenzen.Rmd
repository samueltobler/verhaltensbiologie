...
```{r fig6-1, fig.cap='Evolutionsbiologe William Hamilton in einem Seminar in Harvard, 1978. ', out.width='50%', echo= F, fig.align= 'center'}
...
```{r fig6-2, fig.cap='Das Bienen-Kleiderschrank-Dilemma.', out.width='50%', echo= F, fig.align= 'center'}
knitr::include_graphics('figures/fig6-2.png')
```