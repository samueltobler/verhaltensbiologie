...
```{r fig4-1, fig.cap='Proximate und ultimate Ursachen des Gesangs der Amsel (_Turdus merula_). ', out.width='80%', echo= F, fig.align= 'center'}
...
```{r fig4-2, fig.cap='Die Federpracht des Pfaus (_Pavo cristatus_). ', out.width='80%', echo= F, fig.align= 'center'}
knitr::include_graphics('figures/fig4-2.png')
```
