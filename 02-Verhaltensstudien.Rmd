...
```{r fig2-2, fig.cap='Erdmännchen (_Suricata suricatta_) sind im südlichen Regionen Afrikas beheimatet und leben in kleinen Gruppen. ', out.width='80%', echo= F, fig.align= 'center'}
